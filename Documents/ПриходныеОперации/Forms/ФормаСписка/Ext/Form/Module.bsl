...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("УполномоченноеГашение") Тогда
		...
		Если УполномоченноеГашение Тогда
			...
			ЭтотОбъект.Заголовок = НСтр("ru = 'Уполномоченное гашение'");
		КонецЕсли;
...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	ПараметрУникальности = ?(УполномоченноеГашение, "УполномоченноеГашение", "ПриходнаяОперация");
	
	ОткрытьФорму("Документ.ПриходныеОперации.ФормаОбъекта", ПараметрыФормы, ЭтотОбъект, ПараметрУникальности);
