...
Функция АдресаДляИнтерактивногоВыбора(Родитель, Уровень, ДополнительныеПараметры) Экспорт
	...
	//		ЗаписьЖурналаРегистрации( СобытиеЖурналаРегистрации(), УровеньЖурналаРегистрации.Ошибка, , , Результат.ПодробноеПредставлениеОшибки);
	//	КонецПопытки;
	ИначеЕсли Источник = "Меркурий" Тогда
		
		Попытка
			ИнтеграцияВетисAPIКонтактнаяИнформация.ЗаполнитьАдресаДляИнтерактивногоВыбораМеркурий(Результат, Родитель, Уровень, ДополнительныеПараметры);
		Исключение
			СтруктураОписанияОшибкиПоставщика(Результат, ИнформацияОбОшибке());
			ЗаписьЖурналаРегистрации( СобытиеЖурналаРегистрации(), УровеньЖурналаРегистрации.Ошибка, , , Результат.ПодробноеПредставлениеОшибки);
		КонецПопытки;
...
Функция ВариантыАвтоподбора(Текст, Родитель, Уровни, ДополнительныеПараметры) Экспорт 
	...
	ИначеЕсли Источник = "Меркурий" Тогда
		...
		Попытка
			ИнтеграцияВетисAPIКонтактнаяИнформация.ЗаполнитьСписокАвтоподбораЧастиАдресаМеркурий(Результат, Текст, Родитель, Уровень);
		Исключение
			СтруктураОписанияОшибкиПоставщика(Результат, ИнформацияОбОшибке());
			ЗаписьЖурналаРегистрации( СобытиеЖурналаРегистрации(), УровеньЖурналаРегистрации.Ошибка, , , Результат.ПодробноеПредставлениеОшибки);
		КонецПопытки;
