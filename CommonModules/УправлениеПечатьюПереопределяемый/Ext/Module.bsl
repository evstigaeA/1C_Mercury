...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	//УВС
	СписокОбъектов.Добавить(Документы.АннулированиеВСД);
	СписокОбъектов.Добавить(Документы.АннулированиеВСДГрупповое);
	СписокОбъектов.Добавить(Документы.ВнесениеНомеровТранспортныхСредств);
	СписокОбъектов.Добавить(Документы.ВнесениеНомеровТранспортныхСредствГрупповое);
	СписокОбъектов.Добавить(Документы.ВСД);
	СписокОбъектов.Добавить(Документы.ПриходныеОперации);
	СписокОбъектов.Добавить(Документы.ПриходныеОперацииСводно);
	СписокОбъектов.Добавить(Документы.ТранспортныеОперации);
	СписокОбъектов.Добавить(Документы.ВнесениеСведенийОЛабораторныхИсследованиях);
	
	СписокОбъектов.Добавить(Справочники.СвойстваЗаписейСкладскогоЖурнала);
	//УВС
