...
Функция ПередЧтениемXDTOКонтактнаяИнформация(ТекстXML) Экспорт
	...
	//<УВС
	ТекстXML = СтрЗаменить(ТекстXML, "<IDРегион",   "<rf:IDРегион");
	ТекстXML = СтрЗаменить(ТекстXML, "/IDРегион>",  "/rf:IDРегион>");
	ТекстXML = СтрЗаменить(ТекстXML, "<IDРегион/>", "<rf:IDРегион/>");
	
	ТекстXML = СтрЗаменить(ТекстXML, "<IDРайон",   "<rf:IDРайон");
	ТекстXML = СтрЗаменить(ТекстXML, "/IDРайон>",  "/rf:IDРайон>");
	ТекстXML = СтрЗаменить(ТекстXML, "<IDРайон/>", "<rf:IDРайон/>");
	
	ТекстXML = СтрЗаменить(ТекстXML, "<IDГород",   "<rf:IDГород");
	ТекстXML = СтрЗаменить(ТекстXML, "/IDГород>",  "/rf:IDГород>");
	ТекстXML = СтрЗаменить(ТекстXML, "<IDГород/>", "<rf:IDГород/>");
	
	ТекстXML = СтрЗаменить(ТекстXML, "<IDНаселенныйПункт",   "<rf:IDНаселенныйПункт");
	ТекстXML = СтрЗаменить(ТекстXML, "/IDНаселенныйПункт>",  "/rf:IDНаселенныйПункт>");
	ТекстXML = СтрЗаменить(ТекстXML, "<IDНаселенныйПункт/>", "<rf:IDНаселенныйПункт/>");
	
	ТекстXML = СтрЗаменить(ТекстXML, "<IDУлица",   "<rf:IDУлица");
	ТекстXML = СтрЗаменить(ТекстXML, "/IDУлица>",  "/rf:IDУлица>");
	ТекстXML = СтрЗаменить(ТекстXML, "<IDУлица/>", "<rf:IDУлица/>");
	//>УВС
