...
Процедура ДобавитьЗапись(СтруктураЗаписи, Загрузка = Ложь) Экспорт
	...
	ОбменДаннымиСервер.ДобавитьЗаписьВРегистрСведений(СтруктураЗаписи, "СведенияОбИммунизации", Загрузка);
...
Процедура УдалитьЗапись(СтруктураЗаписи, Загрузка = Ложь) Экспорт
	...
	ОбменДаннымиСервер.УдалитьНаборЗаписейВРегистреСведений(СтруктураЗаписи, "СведенияОбИммунизации", Загрузка);
