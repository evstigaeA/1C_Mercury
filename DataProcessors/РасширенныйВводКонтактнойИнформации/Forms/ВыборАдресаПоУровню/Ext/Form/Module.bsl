...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("УровеньАдреса") Тогда
		ПараметрыПоиска.Вставить("УровеньАдреса", Параметры.УровеньАдреса);
	КонецЕсли;
	...
	Если ДанныеКлассификатора.Отказ Тогда
		...
		КраткоеПредставлениеОшибки = НСтр("ru = 'Получение адресной информации из Меркурия недоступно:'") + Символы.ПС + ДанныеКлассификатора.КраткоеПредставлениеОшибки;
		// >УВС
		Возврат;
